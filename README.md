...
docker pull ghcr.io/cperves/isidareac:version_number
```
* put version number to last available version number
* run it
```shell
docker container run --publish 9090:9090 --detach ghcr.io/cperves/isida:version_number
# server will run on 9090 port but you can change it to another port --publish newport:9090
``` 
