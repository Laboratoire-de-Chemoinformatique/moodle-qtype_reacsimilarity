...
/**
 * Strings for component 'qtype_reacsimilarity', language 'en'
 *
 * @package qtype
...
$string['filloutoneanswer'] = 'You must provide at least one possible answer. Please draw a reaction with the according atom to atom mapping and click on the "Insert given structure as answer/..." button for each answer. ';
