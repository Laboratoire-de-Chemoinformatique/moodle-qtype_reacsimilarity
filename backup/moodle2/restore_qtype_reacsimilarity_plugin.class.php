 ...
 * needed to restore one reacsimilarity qtype plugin
 *
 * @package qtype
 * @subpackage  reacsimilarity
 * @copyright  2023 unistra  {@link http://unistra.fr}
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_reacsimilarity_plugin extends restore_qtype_extrafields_plugin {
    /**
     * Process the qtype/reacsimilarity element
     */
    public function process_reacsimilarity($data) {
