...
/**
 * Upgrader code for the Reacsimilarity question type
 *
 * @package qtype
...
/**
 * Upgrade code for the reacsimilarity question type.
 * @param int $oldversion the version we are upgrading from.
 */
function xmldb_qtype_reacsimilarity_upgrade($oldversion = 0) {
    global $CFG, $DB;

    $dbman = $DB->get_manager();
    if ($oldversion < 2022012405) {
        // Define field id to be added to question_reacsimilarity.
        $table = new xmldb_table('question_reacsimilarity');
        ...
        // Reacsimilarity savepoint reached.
        upgrade_plugin_savepoint(true, 2022012405, 'qtype', 'reacsimilarity');
    }
    if ($oldversion < 2023041100) {
        ...
        upgrade_plugin_savepoint(true, 2023041100, 'qtype', 'reacsimilarity');
